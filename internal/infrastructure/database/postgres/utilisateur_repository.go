...
func (r *UtilisateurRepository) FindByGoogleID(ctx context.Context, googleID string) (*domain.Utilisateur, error) {
...
func (r *UtilisateurRepository) LierGoogleID(ctx context.Context, u *domain.Utilisateur) error {
