// Package kyc contient les structures JSON exposées par l'API HTTP pour
// l'inscription et la revue KYC, et leur conversion vers/depuis les
// types de la couche application (input.InscriptionRequest) et du
// domaine.
package kyc

import "raycard/internal/core/ports/input/kyc"
...
func (d InscriptionRequestDTO) ToUseCaseRequest() kyc.InscriptionRequest {
	return kyc.InscriptionRequest{
		Nom:        d.Nom,
		Prenom:     d.Prenom,
		Email:      d.Email,
...
func FromInscriptionResultat(res *kyc.InscriptionResultat) InscriptionResponseDTO {
