...
func MapErreurDomaine(err error) error {
	switch {
	case errors.Is(err, commun.ErrEmailDejaUtilise), errors.Is(err, commun.ErrTelephoneDejaUtilise), errors.Is(err, kyc.ErrDossierKycDejaEnAttente), errors.Is(err, wallet.ErrTransactionDejaEnCours), errors.Is(err, carte.ErrCardCustomerDejaSoumis):
	...
	case errors.Is(err, commun.ErrPaysNonSupporte), errors.Is(err, commun.ErrDonneesInvalides), errors.Is(err, commun.ErrTransitionKycInvalide), errors.Is(err, kyc.ErrFormatDocumentInvalide), errors.Is(err, kyc.ErrDossierKycNonModifiable),
		...
		errors.Is(err, carte.ErrCardCustomerNonEnrole), errors.Is(err, carte.ErrCardCustomerRejete), errors.Is(err, carte.ErrDocumentsIdentiteAbsents), errors.Is(err, carte.ErrCardWalletInsuffisant),
		errors.Is(err, carte.ErrRetraitEchoue), errors.Is(err, carte.ErrSoldeCarteInsuffisant):
	...
	case errors.Is(err, commun.ErrUtilisateurIntrouvable), errors.Is(err, kyc.ErrDossierKycIntrouvable), errors.Is(err, kyc.ErrDocumentKycIntrouvable), errors.Is(err, authdomain.ErrCleAppareilIntrouvable),
		errors.Is(err, commun.ErrWalletIntrouvable), errors.Is(err, wallet.ErrTransactionIntrouvable), errors.Is(err, carte.ErrCarteIntrouvable), errors.Is(err, commun.ErrPhotoProfilAbsente), errors.Is(err, carte.ErrCardCustomerIntrouvable):
