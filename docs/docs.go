...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/cartes/porteur": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/carte.CardCustomerDTO"
                        }
                    },
                    "401": {
                        "description": "non authentifié",
                    ...
                    "404": {
                        "description": "aucun dossier de porteur de carte",
                        "schema": {
                            "$ref": "#/definitions/commun.ErreurDTO"
                        }
                    },
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Profil du porteur",
                        "name": "porteur",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/carte.SoumettrePorteurCarteRequestDTO"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "un dossier de porteur de carte existe déjà",
                        "schema": {
                            "$ref": "#/definitions/commun.ErreurDTO"
                        }
                    },
                    "422": {
                        "description": "palier KYC insuffisant, ou aucun document d'identité approuvé disponible",
                        "schema": {
                            "$ref": "#/definitions/commun.ErreurDTO"
                        }
                    },
    ...
    "definitions": {
        ...
        "carte.SoumettrePorteurCarteRequestDTO": {
            "type": "object",
            "required": [
                "code_postal",
                "date_naissance",
            ...
            "properties": {
                ...
                "type_document": {
                    "description": "TypeDocument : NIN, PASSPORT, VOTERS_CARD ou DRIVERS_LICENSE (voir la\ndocumentation de l'agrégateur).",
                    "type": "string",
                    "enum": [
                        "NIN",
                        "PASSPORT",
